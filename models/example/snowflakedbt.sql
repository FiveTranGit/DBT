...
REPLACE(REGEXP_SUBSTR(data, 'Email(.*?@@gmail\.com)', 1, 1, 'e'), '@@', '@') AS 
Email, 
...
FROM elt.dirtydata.data 
CROSS JOIN LATERAL 
SPLIT_TO_TABLE(BIO_DATA_WITH_INFORMATION_ON_NAME_EMAIL_AGE_CITY_OF_BIRTH_AND_GENDER, '\n') 
) t 
